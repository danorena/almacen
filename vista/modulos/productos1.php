        ...
        <table id="tablaHumano" class="table table-dark table-striped">
          ...
          <tbody>
            ...
            foreach ($arrayHumano as $campo) {
              ...
              $pcant = $objHumano->crtProductoDisponibleEntrega($cod);
            ?>
              <div>
                <h1 class="dpl" id="<?php echo 'cantp' . $cod; ?>"><?php echo $pcant['disponible'];  ?></h1>
              ...
              <tr>
                ...
                <td>
                  <button type='button' onclick='solicitarProducto(<?php echo "cod" . $cod; ?>, <?php echo "img" . $cod ?>, <?php echo "cantp" . $cod; ?> )' class='btn btn-success' data-toggle='modal' data-target="#modalSolicitar"><i class='fa fa-plus'></i></button>
...
<div tabindex="-1" class="modal fade" id="modalSolicitar" role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header" style='background:#3c8dbc; color:white;'>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h1 id="nombre_producto_mld1" class="modal-title">NOMBRE PRODUCTO</h1>
      </div>
        ...
        <div class="container" style="width: auto;">
          <div class="row">
            <div class='col-sm-5 col-md-5 col-lg-5 col-xl-5'>
              <div>
                <img id="img_mld1" src="" alt="" class="img_div">
              </div>
            </div>
            <div class='col-sm-4 col-md-4 col-lg-4 col-xl-4'>
              <div class="info-producto">
                <h1>seleccione la cantidad</h1>
                <form method="POST">

                  <input type="hidden" id="id_producto1" name="id_producto1">
                  <input id="cantidadSolicitada" required name="cantidadSolicitada" type="number" min="1">
                  <button type="submit" class="btn btn-success">Solicitar</button>
                  <?php
                  if (isset($_POST['cantidadSolicitada'])) {
                    $objProducto = new ControladorSolicitudes();
                    if ($objProducto->ctrInsertarSolicitud()) {
                      echo '<script>
        ...
        <div class='form-group'>
          <div class="modal-body">
            ...
            <div>
              ...
              <div class="dpl" class='form-group'>
              ...
              <div class="dpl" class='form-group'>
                <div class='input-group'>
                  <span class='input-group-addon'><i class='fa fa-sticky-note'></i></span>
                  <input id='txtModPresentacion' type='text' class='form-control input-lg' name='txtModPresentacion' placeholder='Ingrese la presentación'>
                </div>
              </div>
              ...
              <div class='form-group'>
                <div class='input-group'>
                  <span class='input-group-addon'><i class='fa fa-sticky-note'></i></span>
                  <input id='txtModUbicacionFisica' type='text' class='form-control input-lg' name='txtModUbicacionFisica' placeholder='Ingrese la ubicación física'>
                </div>
              </div>
              ...
              <div class='form-group'>
                <div class='input-group'>
                  <span class='input-group-addon'><i class='fa fa-sticky-note'></i></span>
                  <input id='txtModDevolucionCompras' type='text' class='form-control input-lg' name='txtModDevolucionCompras' placeholder='Ingrese la devolución de compras'>
                </div>
              </div>
